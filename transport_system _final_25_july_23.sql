...
CREATE TABLE `admin_details` (
  ...
  `status` set('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '1',
...
CREATE TABLE `employee` (
  ...
  `gender` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'M',
...
CREATE TABLE `route_employee_relation` (
  ...
  `emp_id` int NOT NULL,
  `status` set('0','1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '2',
...
CREATE TABLE `timing` (
  ...
  `timeperiod` set('M','E') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `status` set('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '1',
...
CREATE TABLE `vehicle` (
  ...
  `vehicle_no` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
